  ...
  return (
    <div className="w-full max-w-full overflow-hidden max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-lg mb-6">
        <div className=" w-full h-12 rounded-xl border px-4 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500-b border-gray-200">
          <nav className="flex">
            {tabs.map((tab) => {
              const Icon = tab.icon;
              return (
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 w-full h-12 rounded-xl border px-4 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
